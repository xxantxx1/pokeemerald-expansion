const struct MonCoords gTrainerFrontPicCoords[] =
{
	...
	[TRAINER_PIC_VIOLA] = {.size = 8, .y_offset = 1},
	[TRAINER_PIC_GRANT] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
	...
	TRAINER_SPRITE(VIOLA, gTrainerFrontPic_Viola, 0x800),
	TRAINER_SPRITE(GRANT, gTrainerFrontPic_Grant, 0x800),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
	...
	TRAINER_PAL(VIOLA, gTrainerPalette_Viola),
	TRAINER_PAL(GRANT, gTrainerPalette_Grant),
};
