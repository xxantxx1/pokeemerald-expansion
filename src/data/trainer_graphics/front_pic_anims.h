...
static const union AnimCmd *const sAnims_Viola[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Grant[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
	...
	[TRAINER_PIC_VIOLA] = sAnims_Viola,
	[TRAINER_PIC_GRANT] = sAnims_Grant,
