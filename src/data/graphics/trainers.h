...
const u32 gTrainerFrontPic_Viola[] = INCBIN_U32("graphics/trainers/front_pics/viola_front_pic.4bpp.lz");
const u32 gTrainerPalette_Viola[] = INCBIN_U32("graphics/trainers/palettes/viola.gbapal.lz");

const u32 gTrainerFrontPic_Grant[] = INCBIN_U32("graphics/trainers/front_pics/grant_front_pic.4bpp.lz");
const u32 gTrainerPalette_Grant[] = INCBIN_U32("graphics/trainers/palettes/grant.gbapal.lz");
