...
static const u8 sMapName_LittlerootSanctuary[] = _("");
static const u8 sMapName_LittlerootSanc[] = _("LITTLEROOT SANC");
...
const struct RegionMapLocation gRegionMapEntries[] = {
    ...
    [MAPSEC_LITTLEROOT_SANC]            = {5, 10, 1, 1, sMapName_LittlerootSanc},
